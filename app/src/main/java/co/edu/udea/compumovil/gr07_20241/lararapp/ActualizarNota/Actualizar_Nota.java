package co.edu.udea.compumovil.gr07_20241.lararapp.ActualizarNota;
...
public class Actualizar_Nota extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    Button Btn_Calendario_A,Btn_Actualizar_Nota;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Btn_Actualizar_Nota.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ActualizarNotaBD();
            }
    ...
    private void InicializarVistas(){
        ...
        Btn_Actualizar_Nota = findViewById(R.id.Actualizar_Nota_BD);
