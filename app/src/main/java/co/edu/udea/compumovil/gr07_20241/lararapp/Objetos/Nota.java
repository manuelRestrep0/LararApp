package co.edu.udea.compumovil.gr07_20241.lararapp.Objetos;

public class Nota {

    String id_nota, uid_usuario, correo_usuario, fecha_hora_actual, titulo,
    descripcion, fecha_nota, estado;

    public Nota() {
    }

    public Nota(String id_nota, String uid_usuario, String correo_usuario, String fecha_hora_actual,
